...
public class Niveau1 extends NiveauBase {
...
//**** CONSTRUCTEUR ****//	
    ...
    this.scoreTotal = 2000; // Initialisez scoreTotal à 0
...
private boolean partiePerdue() {
    if(this.mario.isVivant() == false || this.compteARebours.getCompteurTemps() <= 0) {
        // Diminuer le score total en fonction du temps écoulé
        int tempsEcoule = tempsInitial - this.compteARebours.getCompteurTemps();
        this.scoreTotal -= tempsEcoule * 5; // par exemple, 5 points par seconde écoulée
        return true;
    } else {
        return false;
    }
